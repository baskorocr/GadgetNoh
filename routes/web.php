...
Route::get('createproduct', \App\Http\Livewire\CreateProduct::class)->name('createproduct')->middleware('is_admin');
Route::post('addproduct',[\App\Http\Livewire\CreateProduct::class,'store'])->middleware('is_admin');
Route::get('edit/{Id}', \App\Http\Livewire\Update::class)->name('edit')->middleware('is_admin');
Route::post('update', [\App\Http\Livewire\Update::class,'update'])->middleware('is_admin');